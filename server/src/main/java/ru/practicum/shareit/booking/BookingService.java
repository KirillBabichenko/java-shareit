...
public interface BookingService {
    ...
    List<BookingDto> getAllBookings(Long idUser, String text, Integer from, Integer size);

    List<BookingDto> getAllOwnerBookings(Long idUser, String text, Integer from, Integer size);
